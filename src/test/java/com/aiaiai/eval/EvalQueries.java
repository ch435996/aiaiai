...
public class EvalQueries {
    ...
    public static List<EvalQuery> all() {
        ...
        list.add(new EvalQuery("M1", "点云补全的损失函数有哪些",
                Category.CONCEPT,
                new String[]{"Survey_of_Point_Cloud_Completion", "PCN", "PoinTr",
                        "SeedFormer", "ProtoComp", "SnowflakeNet"},
                "概念覆盖 → 多篇相关论文"));
        list.add(new EvalQuery("M2", "Transformer 在点云补全中的应用",
                Category.CONCEPT,
                new String[]{"PoinTr", "Point_Transformer", "SnowflakeNet",
                        "Survey_of_Point_Cloud_Completion", "SeedFormer", "ProxyFormer"},
                "跨方法概念 → 多篇使用Transformer的论文"));
        list.add(new EvalQuery("M3", "coarse-to-fine 策略在点云补全中",
                Category.CONCEPT,
                new String[]{"PCN", "SeedFormer", "Survey_of_Point_Cloud_Completion", "ProtoComp"},
                "策略模式 → 使用C2F的方法"));

        list.add(new EvalQuery("L1", "三维重建的评价指标",
                Category.CONCEPT,
                new String[]{"Survey_of_Point_Cloud_Completion"},
                "元概念 → 主要在Survey中讨论"));
        list.add(new EvalQuery("L2", "点云上采样和补全有什么区别",
                Category.CONCEPT,
                new String[]{"Survey_of_Point_Cloud_Completion", "PCN", "SeedFormer"},
        ...
        list.add(new EvalQuery("X6", "diffusion做补全有什么优势？记住我关注推理延迟",
                Category.MIXED_INTENT,
                new String[]{"DiPT", "PCDreamer", "PointDiffuse", "Repurposing", "Simba",
                        "Survey_of_Point_Cloud_Completion"},
                "技术路线+记忆 → diffusion论文"));
        ...
        list.add(new EvalQuery("T4", "CD损失和EMD损失的区别是什么",
                Category.TYPO_VARIANT,
                new String[]{"Survey_of_Point_Cloud_Completion", "PCN", "PoinTr", "ProtoComp"},
                "缩写CD/EMD → 损失函数讨论"));
        ...
        // ── 口语化/情绪化 (4) ──
        list.add(new EvalQuery("O1", "哎这个模型怎么训练的来着",
